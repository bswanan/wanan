...
$return = aceload('home','word='.$word.'&page='.$page,$key);

$out = getleftstr($return,'|||');
$allpage = getsubstr($return,'|||','|1|');
$logintype = getrightstr($return,'|1|');
if($logintype == 'true'){
    $islogin = true;
}else{
    $islogin = false;
                    ...
                    <div class="row">
                        <div  class="subscribe-form" style="text-align: center;">
                            <fieldset class="col-md-offset-4 col-md-3 col-sm-8">
                                <input type="text" id="subscribe-email" placeholder="搜索关键词" required="required">
                            </fieldset>
                            <fieldset class="col-md-5 col-sm-4">
                                <input type="submit" id="subscribe-submit" class="button white" onclick="search();" value="搜索">
                            </fieldset>
                        </div>
                    </div>
                </div>
                    ...
                    getPage:function (page)
                         {
                             ...
                             if($word == ""){
                                ...
                                echo 'window.location.href="?word='.$word.'&p="+page;';  
                             }
