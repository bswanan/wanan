...
<html class="no-js">
    ...
    <body>
            ...
            <div class="site-banner">
                <div class="container">
                    <div class="row" style="font-size:18px;">
                        <p>欢迎您：<span style="color:#fff"><?php echo $name; ?></span> 欢迎您回来！</p>
                        <p>您目前的会员等级：<?php 
                        switch ($viptype) {
                            case '1':
                                echo '<span style="color:#ff7c7c">乐享会员</span>';
                                break;
                            case '2':
                                echo '<span style="color:aqua">臻享会员</span>';
                                break;
                            default:
                                echo '<span style="color:#fff">普通会员</span>';
                                break;
                        }
                        ?></p>
                        <p>有效期至：<?php 
                        switch ($viptype) {
                            ...
                            case '2':
                                ...
                                break;
                            default:
                                echo '<span style="color:#fff;">无到期时间</span>';
                                break;
                        }
                        ?></p>
                        <hr>
                        <h3>激活会员卡   <a href="<?php echo $paylink; ?>" target="_blank" style="font-size:small;">前往购卡</a></h3>
                        
                        <div  class="subscribe-form">
                            <fieldset class="col-md-offset-4 col-md-3 col-sm-8" style="margin-left:0;">
                                <input type="text" id="subscribe-email" placeholder="输入礼品卡号" required="required">
                            </fieldset>
                            <fieldset class="col-md-5 col-sm-4">
                                <input type="submit" id="subscribe-submit" class="button white" onclick="upcard();" value="提交">
                            </fieldset>
                        </div>
        ...
        <div class="main-posts" style="text-align:center;">
            <h2 style="margin-bottom:60px;">我的收藏</h2>
            <div class="container">
