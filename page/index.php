...
$return = aceload('page','pp='.$_GET['pp'],$key);

$postname = getleftstr($return,'|||');
$allpage = getsubstr($return,'|1|','|2|');
$sccode = getsubstr($return,'|||','|1|');
...
<html class="no-js">
    <head>
        ...
        <title><?php echo $postname; ?>-<?php echo $title;?></title>
    ...
    <body>
        ...
        <div class="main-posts" style="text-align:center;">
            ...
            <div class="container">
                <div class="load" style="max-width:800px;margin: 0 auto;">
                         <?php echo $out ?>
                </div>
            ...
            window.onload = function () {
                new myPagination(
                    ...
                    getPage:function (page)
                         {
                             window.location.href="<?php echo '?pp='.$_GET['pp'] ?>&p=" + page;
                         }
            })
            }
        </script>
        <script type="text/javascript">
            ...
            $('#img').error(function() {
               ...
               setTimeout(function () {
                  if(retry>3){
                     _this.attr("src","/static/images/imgError.png");//设置碎图
                  }else{
                     retry++;
  ...
  url: "../load.php",
  dataType: 'json',
  data:{'pp':'<?php echo $_GET['pp']; ?>','page':'<?php echo $page; ?>'},
  success: function (data) {
      switch (data.code) {
          case '200':
            $('.load').append(data.message);
